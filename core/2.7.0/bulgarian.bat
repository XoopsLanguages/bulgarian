...
echo Replacing "english" with "bulgarian" in all folder and file names...
...
for /f "delims=" %%a in ('dir /b /s /ad ^| sort /r') do (
    ...
    if "!foldername!"=="!foldername:english=!" (
        ...
        set "newfoldername=!foldername:english=bulgarian!"
        set "parentpath=%%~dpa"
...
for /f "delims=" %%a in ('dir /b /s /a-d') do (
    ...
    if "!filename!"=="!filename:english=!" (
        ...
        set "newfilename=!filename:english=bulgarian!"
        set "parentpath=%%~dpa"
